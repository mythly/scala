...
/*
class FlexibleFamily(mom: String = "Mom", dad: String = "Dad", kids: String*) {
...
val family3 = new FlexibleFamily(mom = "Mom", dad = "Dad", "Sally", "Dick")
family3.familySize() is 4

/*
val family4 = new FlexibleFamily(dad = "Dad", mom = "Mom", "Harry")
family4.familySize() is 3
*/
